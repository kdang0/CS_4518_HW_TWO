...
/*
    private fun updatePts(Team: String, Points: Int) {
        if (Team == "A") {
            teams[0].score = Points + teams[0].score
            textAPTS.setText(teams[0].score.toString())
        } else {
            teams[1].score = Points + teams[1].score
            textBPTS.setText(teams[1].score.toString())
        }
    }
